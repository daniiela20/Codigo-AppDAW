...
public class UnitThreeActivity extends AppCompatActivity {
    ...
    private Button btn_menu_quiz_three;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_menu_quiz_three = (Button) findViewById(R.id.btn_menu_quiz_three);
        btn_menu_quiz_three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
