...
public class QuizOneActivity extends AppCompatActivity {
    ...
    private QuestionLibraryOne mQuestionLibrary = new QuestionLibraryOne();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), ScoreOneActivity.class);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (mButtonChoice1.getText() == mAnswer){
                    ...
                    Toast.makeText(QuizOneActivity.this, "Correcta", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(QuizOneActivity.this, "Incorrecta", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
            }
        });
    ...
    private void updateQuestion()
    {
        try {
            ...
            if(mQuestionNumber>5){
                Toast.makeText(QuizOneActivity.this, "SE HA FINALIZADO EL QUIZ", Toast.LENGTH_LONG).show();
    ...
    private void savePoints() {
        ...
        Intent intent = new Intent(QuizOneActivity.this, ScoreOneActivity.class);
