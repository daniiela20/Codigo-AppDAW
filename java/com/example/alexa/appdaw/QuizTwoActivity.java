...
public class QuizTwoActivity extends AppCompatActivity {
    ...
    private QuestionLibraryTwo mQuestionLibrary = new QuestionLibraryTwo();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), ScoreTwoActivity.class);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (mButtonChoice1.getText() == mAnswer){
                    ...
                    Toast.makeText(QuizTwoActivity.this, "Correcta", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(QuizTwoActivity.this, "Incorrecta", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
            }
        });
    ...
    private void updateQuestion()
    {
        try {
            ...
            if(mQuestionNumber>5){
                Toast.makeText(QuizTwoActivity.this, "SE HA FINALIZADO EL QUIZ", Toast.LENGTH_LONG).show();
    ...
    private void savePoints() {
        ...
        Intent intent = new Intent(QuizTwoActivity.this, ScoreTwoActivity.class);
